...
FID_TO_TYPE_ENUM  (
    ...
    FTYPE_ENUM  (
        ...
        CAPTURE_MODE_HDR, 
        CAPTURE_MODE_ASD,
        CAPTURE_MODE_ZSD,                           //  Zero-shutter-delay Shot //added for kk qus1 
        CAPTURE_MODE_PANO_3D,
        CAPTURE_MODE_SINGLE_3D,
        CAPTURE_MODE_FACE_BEAUTY,
        CAPTURE_MODE_CONTINUOUS_SHOT,
        CAPTURE_MODE_MULTI_MOTION, 		// added for kk qus1
        NUM_OF_CAPTURE_MODE
    )
) CAPTURE_MODE_T;
...
FID_TO_TYPE_ENUM  (
    ...
    FTYPE_ENUM  (
        ...
        CAPTURE_SIZE_1280_720, //added for kk qus1
...
FID_TO_TYPE_ENUM  (
    ...
    FTYPE_ENUM  (
		...
		PREVIEW_SIZE_384_288, //added for kk qus1
